...
public class ClockController : MonoBehaviour
{
    ...
    public GameObject ratonJugando;
    ...
    void Start()
    {
        ...
        ratonJugando.SetActive(false);
        mandos.SetActive(true);
    ...
    void Update()
    {
        ...
        //mi logica
        if(_elapsedTime>10f && _elapsedTime<10.1f){
            ...
            ratonJugando.SetActive(true);
            mandos.SetActive(false);
